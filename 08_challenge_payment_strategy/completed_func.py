...
# ! Same thing but use only functions
...
class ShoppingCart:
    ...
    def process_payment(self, method:str):
        ...
        self.payment_method(self.total)




def process_credit_card_payment(total: Decimal) -> None:
...
def process_paypal_payment(total: Decimal) -> None:
...
def process_apple_pay_payment(total: Decimal) -> None:
...
PAYMENT_METHODS = {
    "cc": process_credit_card_payment,
    "paypal" : process_paypal_payment,
    "apple" : process_apple_pay_payment
}
